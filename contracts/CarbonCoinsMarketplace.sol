...
contract CarbonToken is ERC20, Ownable {
    ...
    ) ERC20("CarbonCoin", "CC") Ownable(initialOwner) {}
...
contract CarbonMarketplace is ReentrancyGuard, Ownable {
    ...
    function approveClaim(
        ...
        require(
            _eligibleTokens <= claims[_claimId].demandedTokens,
            "Eligible tokens cannot exceed demanded tokens"
        );
